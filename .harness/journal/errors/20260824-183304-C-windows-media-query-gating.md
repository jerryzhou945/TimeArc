# Error Report - windows-media-query-gating

## Metadata

- Level: **L1**
- Track: **C**
- Topic: windows-media-query-gating
- Recorded: 2026-08-24T18:33:04Z
- Session: (unknown)
- Platform: n-a
- Tooling: (fill in)
...
```
[1/6] Automatic MOC and UIC for target timearc_windows_audio_title_policy_test
[2/5] Building C object CMakeFiles/timearc_windows_audio_title_policy_test.dir/src/service/windows/platform/audio_win.c.obj
[3/5] Building C object src/service/CMakeFiles/time_arc_service.dir/windows/platform/audio_win.c.obj
[4/5] Linking C executable time-arc-service.exe
...
[5/5] Linking CXX executable timearc_windows_audio_title_policy_test.exe
