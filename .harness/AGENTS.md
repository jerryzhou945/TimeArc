...
that stores foreground/audio usage in a service-owned SQLite database. Target
platforms: Windows (most complete), macOS (in progress), Linux (not started).
If this is new, stop and read `CHARTER.md` §1–2.
