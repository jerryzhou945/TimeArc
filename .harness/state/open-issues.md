...
- **No whole-DB backup/restore (D1).** Only report/prefs JSON export today. Plan
  (S1 backup `VACUUM INTO` → S2 restore): [`kickoff`](../../docs/d1-export-backup-restore-kickoff.md).
