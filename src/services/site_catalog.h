...
inline const QVector<SiteDefinition>& sites() {
  static const QVector<SiteDefinition> entries = {
      ...
      {QStringLiteral("site:xiaohongshu"), QStringLiteral("\u5C0F\u7EA2\u4E66"),
       ...
       QStringLiteral("qrc:/qt/qml/time_arc/resources/icons/sites/xiaohongshu.png"),
      ...
      {QStringLiteral("site:weibo"), QStringLiteral("\u5FAE\u535A"),
       ...
       QStringLiteral("#E6162D"), QStringLiteral("\u5FAE"),
       QStringLiteral("qrc:/qt/qml/time_arc/resources/icons/sites/weibo.ico"),
      ...
      {QStringLiteral("site:zhihu"), QStringLiteral("\u77E5\u4E4E"),
       ...
       QStringLiteral("#1772F6"), QStringLiteral("\u77E5"),
       QStringLiteral("qrc:/qt/qml/time_arc/resources/icons/sites/zhihu.png"),
      ...
      {QStringLiteral("site:taobao"), QStringLiteral("\u6DD8\u5B9D"),
       ...
       QStringLiteral("#FF5000"), QStringLiteral("\u6DD8"),
       QStringLiteral("qrc:/qt/qml/time_arc/resources/icons/sites/taobao.png"),
      ...
      {QStringLiteral("site:tmall"), QStringLiteral("\u5929\u732B"),
       ...
       QStringLiteral("#DD2727"), QStringLiteral("\u732B"),
       QStringLiteral("qrc:/qt/qml/time_arc/resources/icons/sites/tmall.png"),
      ...
      {QStringLiteral("site:jd"), QStringLiteral("\u4EAC\u4E1C"),
       ...
       QStringLiteral("#E2231A"), QStringLiteral("\u4EAC"),
       QStringLiteral("qrc:/qt/qml/time_arc/resources/icons/sites/jd.ico"),
      ...
      {QStringLiteral("site:pinduoduo"), QStringLiteral("\u62FC\u591A\u591A"),
       ...
       QStringLiteral("#E02E24"), QStringLiteral("\u62FC"),
       QStringLiteral("qrc:/qt/qml/time_arc/resources/icons/sites/pinduoduo.png"),
      ...
      {QStringLiteral("site:baidu"), QStringLiteral("\u767E\u5EA6"),
       ...
       QStringLiteral("#2932E1"), QStringLiteral("\u767E"),
       QStringLiteral("qrc:/qt/qml/time_arc/resources/icons/sites/baidu.png"),
      ...
      {QStringLiteral("site:iqiyi"), QStringLiteral("\u7231\u5947\u827A"),
       ...
       QStringLiteral("qrc:/qt/qml/time_arc/resources/icons/sites/iqiyi.png"),
      ...
      {QStringLiteral("site:youku"), QStringLiteral("\u4F18\u9177"),
       ...
       QStringLiteral("qrc:/qt/qml/time_arc/resources/icons/sites/youku.png"),
      ...
      {QStringLiteral("site:tencent-video"),
       ...
       QStringLiteral("qrc:/qt/qml/time_arc/resources/icons/sites/tencent-video.png"),
      ...
      {QStringLiteral("site:mango-tv"), QStringLiteral("\u8292\u679CTV"),
       ...
       QStringLiteral("qrc:/qt/qml/time_arc/resources/icons/sites/mango-tv.png"),
      ...
      {QStringLiteral("site:acfun"), QStringLiteral("AcFun"),
       ...
       QStringLiteral("qrc:/qt/qml/time_arc/resources/icons/sites/acfun.png"),
      ...
      {QStringLiteral("site:netflix"), QStringLiteral("Netflix"),
       ...
       QStringLiteral("qrc:/qt/qml/time_arc/resources/icons/sites/netflix.png"),
      ...
      {QStringLiteral("site:douban"), QStringLiteral("\u8C46\u74E3"),
       ...
       QStringLiteral("#007722"), QStringLiteral("\u8C46"),
       QStringLiteral("qrc:/qt/qml/time_arc/resources/icons/sites/douban.ico"),
      ...
      {QStringLiteral("site:alipay"), QStringLiteral("\u652F\u4ED8\u5B9D"),
       ...
       QStringLiteral("#1677FF"), QStringLiteral("\u652F"),
       QStringLiteral("qrc:/qt/qml/time_arc/resources/icons/sites/alipay.png"),
      ...
      {QStringLiteral("site:meituan"), QStringLiteral("\u7F8E\u56E2"),
       ...
       QStringLiteral("#FFD100"), QStringLiteral("\u56E2"),
       QStringLiteral("qrc:/qt/qml/time_arc/resources/icons/sites/meituan.ico"),
      ...
      {QStringLiteral("site:dianping"), QStringLiteral("\u5927\u4F17\u70B9\u8BC4"),
       ...
       QStringLiteral("#FF7A00"), QStringLiteral("\u70B9"),
       QStringLiteral("qrc:/qt/qml/time_arc/resources/icons/sites/dianping.ico"),
