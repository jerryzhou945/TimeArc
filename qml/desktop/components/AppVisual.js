...
function siteVisual(appId) {
    ...
    case "site:xiaohongshu": return { color: "#F5D7DE", label: "\u7EA2", icon: Qt.resolvedUrl("../../../resources/icons/sites/xiaohongshu.ico") };
    ...
    case "site:iqiyi": return { color: "#D8F0D6", label: "\u7231", icon: Qt.resolvedUrl("../../../resources/icons/sites/iqiyi.ico") };
    ...
    case "site:acfun": return { color: "#F5D7DD", label: "A", icon: Qt.resolvedUrl("../../../resources/icons/sites/acfun.ico") };
    case "site:youtube": return { color: "#F2D4D4", label: "Y", icon: Qt.resolvedUrl("../../../resources/icons/sites/youtube.png") };
    case "site:netflix": return { color: "#EFD3D5", label: "N", icon: Qt.resolvedUrl("../../../resources/icons/sites/netflix.ico") };
