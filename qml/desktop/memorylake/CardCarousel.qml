    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Text {
                ...
                text: carousel.locked ? I18n.t(carousel.languageMode, "Locked: unflip the card before switching")
                                      : I18n.t(carousel.languageMode, "Wheel or left ranking switches the current app; hover to preview")
        ...
        Rectangle {
            ...
            Row {
                ...
                Text {
                    anchors.verticalCenter: parent.verticalCenter
                    text: I18n.t(carousel.languageMode, "Wheel to switch · Click to expand")
        ...
        Rectangle {
            ...
            Text {
                id: lockText
                anchors.centerIn: parent
                text: I18n.t(carousel.languageMode, "Memory expanded · Click the card again to return")
